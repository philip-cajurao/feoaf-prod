...
const executiveBoard = [
  ...
  },
  {
    ...
    description: "Dedicated community supporter and advocate for youth development. As a board member of the Future Entrepreneurs of America Foundation (FEOAF), An brings valuable insight, leadership, and a passion for helping young people build confidence and entrepreneurial skills."
  }
];

const boardMembers = [
  {
    name: "Sylvia Severson",
    role: "Board Member",
    color: "text-red-500",
    ...
    <div className="flex flex-col relative overflow-x-hidden">
      ...
      <div className="relative overflow-hidden pt-8 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 relative">
          ...
          {/* Executive Board */}
          <div className="mb-16">
            <h4 className="text-2xl font-bold text-center text-gray-800 mb-8 border-b pb-4 max-w-2xl mx-auto">Executive Board</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {executiveBoard.map((member, index) => (
                <div key={index} className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
          ...
          {/* Board Members */}
          <div className="mb-16">
            <h4 className="text-2xl font-bold text-center text-gray-800 mb-8 border-b pb-4 max-w-2xl mx-auto">Board Members</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {boardMembers.map((member, index) => (
                <div key={index} className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                  <h5 className="text-xl font-bold text-gray-900">{member.name}</h5>
                  <span className={`${member.color} font-bold mt-1`}>{member.role}</span>
                  <p className="text-gray-600 text-sm leading-relaxed mt-3">{member.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mb-16 bg-white/60 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-100">
            ...
            <p className="text-center text-gray-600 italic mb-10 max-w-3xl mx-auto">
              These youth leaders represent the voice of the next generation and help shape programs, events, and initiatives of Future Entrepreneurs of America Foundation.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <h6 className="font-bold text-blue-600 mb-2 text-lg">Editor-in-Chief – Youth Newsletter</h6>
          ...
          {/* Closing Line */}
          <div className="mt-16 text-center max-w-4xl mx-auto relative z-10">
            <p className="text-xl text-gray-700 italic font-medium leading-relaxed bg-white/50 backdrop-blur-sm p-4 rounded-xl inline-block">
              “Our Board of Directors is composed of community leaders, educators, entrepreneurs, and professionals who share a common mission: empowering the next generation of innovators, leaders, and entrepreneurs.”
            </p>
          </div>
        </div>
